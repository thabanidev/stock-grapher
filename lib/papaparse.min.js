...
!(function (e, t) {
                ...
                if (Array.isArray(e)) {
                    ...
                    return (
                        ...
                        Array.isArray(e.data) &&
                            (e.fields ||
                                (e.fields = (e.meta && e.meta.fields) || i),
                            e.fields ||
    ...
    function E(j) {
        var z,
            ...
            B = j.fastMode,
            K = (z =
                void 0 === j.quoteChar || null === j.quoteChar
                    ? '"'
                    : j.quoteChar);
        if (
            (void 0 !== j.escapeChar && (K = j.escapeChar),
            ("string" != typeof M || -1 < b.BAD_DELIMITERS.indexOf(M)) &&
                (M = ","),
            U === M)
        )
            ...
            for (
                ...
                if (i[W] !== z)
                    if (U && 0 === f.length && i.substring(W, W + a) === U) {
                        ...
                        f.push(i.substring(W, w)),
                            (W = w + e),
                            (w = i.indexOf(M, W));
                    else {
                        if (-1 === R) break;
                        if (
                            (f.push(i.substring(W, R)), D(R + s), o && (F(), H))
                        )
                            return L();
                    ...
                    for (S = W, W++; ; ) {
                        ...
                        if (z !== K || i[S + 1] !== K) {
                            if (z === K || 0 === S || i[S - 1] !== K) {
                                ...
                                var x = A(R);
                                if (
                                    i.substring(S + 1 + x, S + 1 + x + s) === P
                                ) {
                                    if (
                                        (f.push(
                                            i.substring(W, S).replace(C, z)
                                        ),
                                        D(S + 1 + x + s),
                                        (w = i.indexOf(M, W)),
                                        (S = i.indexOf(z, W)),
